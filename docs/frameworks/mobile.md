...
There is no Swift package and no Kotlin artifact. There is a 24 KB script that
...
for as long as the connection is bad, and the file is 24 KB.
...
lost zoom and a fresh 24 KB parse. Everything is a call: `applyOptions`,
`setData`, `update`.
