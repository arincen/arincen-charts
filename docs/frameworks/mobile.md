...
There is no Swift package and no Kotlin artifact. There is a 22 KB script that
...
for as long as the connection is bad, and the file is 22 KB.
...
lost zoom and a fresh 22 KB parse. Everything is a call: `applyOptions`,
`setData`, `update`.
