...
|---|---|---|---|
| **Light** | `@arincen/charts` | ~18 KB | Six series types, crosshair, markers, price lines, primitives, pan and zoom |
| **Full** | `@arincen/charts/full` | ~23 KB | All of that, plus panes, logarithmic / percentage / indexed scales, left and overlay scales, custom series, watermarks, touch tracking, kinetic scroll |
...
with the size budget, which fails if the light bundle grows past 19 KB.
