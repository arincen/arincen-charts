...
Whole solutions to the things people actually build, rather than options in
isolation. Each one runs on this page.

| | |
|---|---|
| [Synchronised charts](/recipes/synced-charts) | two charts, one pointer and one range — and the feedback loop you have to break |
